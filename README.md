...
```
> **Nota importante**: Asegúrate de que todas las dependencias se instalen correctamente.

- Para la migración:
```bash
$ python manage.py migrate
```
> **Para cualquier migración, hablar con @alexfonfdz de preferencia**

- Para ejecutar:
```bash
$ python manage.py runserver
```
> **Nota importante**: Asegúrate de que el servidor se ejecute correctamente.
